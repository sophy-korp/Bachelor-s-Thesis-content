...
%%
%%
\newcommand{\Author}{С.Д.\,Корпусова} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Корпусова Софья Дмитриевна} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Корпусовой Софье Дмитриевне} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Корпусову Софью Дмитриевну} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-911-135-35-30} % номер телефорна автора для оперативной связи  
\newcommand{\Supervisor}{А.Н.\,Баженов} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorFull}{Баженов Александр Николаевич} % Фамилия Имя Отчество научного руководителя
\newcommand{\SupervisorVin}{А.Н.\,Баженова} % И. О. Фамилия научного руководителя  в винительном падеже (Кого? что? Руководителя ...)
...
%%
%%
\renewcommand{\thesisTitle}{Применение матрицы отношений для построения гистограмм и нахождения моды интервальной выборки}
\newcommand{\thesisDegree}{работа бакалавра}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Relationship matrix applying for plotting histograms and finding the interval sampling mode} %2020
\newcommand{\thesisDeadline}{06.05.2025} %Последний день преддипломной практики согласно учебному плану.
\newcommand{\thesisStartDate}{10.09.2024}
...
%%
%%
\newcommand{\keywordsRu}{Матрица отношений, мода интервальной выборки, элементарные подынтервалы, граф совместности, коэффициент Жаккара, гистограмма распределения частот, кумулятивная сумма} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Relationship matrix, interval sampling mode, elementary subintervals, compatibility graph, Jaccard coefficient, frequency distribution histogram, cumulative sum} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{В данной работе } % ВВЕДИТЕ текст аннотации по-русски
%%
%%
